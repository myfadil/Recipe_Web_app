...
export default function Bookmark() {
    ...
    const getData = () => {
        axios.get(import.meta.env.VITE_BASE_URL + `LikeAndBookmark/bookmark?UserID=${localStorage.getItem("id")}`, {
            headers: {
            ...
            buttons: [
                {
                    label: "Delete",
                    onClick: () => {
                        axios.delete(import.meta.env.VITE_BASE_URL + `LikeAndBookmark/bookmark?UserID=${localStorage.getItem("id")}&ResepID=${item.id}`, {
                            headers: {
                                Authorization: `Bearer ${localStorage.getItem("token")}`
                            }
                        })
